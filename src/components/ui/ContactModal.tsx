            ...
            <div className=" max-h-[90vh] md:h-fit relative w-full max-w-4xl mx-auto overflow-x-scroll md:overflow-hidden rounded-2xl shadow-2xl bg-white flex flex-col md:flex-row">
              ...
              <div className="relative w-full md:w-5/12 bg-gradient-to-br from-teal-500 via-teal-600 to-emerald-700 p-4 md:p-12">
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                  ...
                  <div className="absolute bottom-0 right-0 w-60 h60 bg-white/10 rounded-full translate-x-1/3 translate-y-1/3" />
                ...
                <div className="relative z-10">
                  ...
                  <motion.p
                    ...
                    className={"text-white/90 md:-mb8"}
                  >
              ...
              <div className="w-full md:w-7/12 p-4 md:p-12 text-[#263C28]">
                <motion.div
                  ...
                  transition={{ delay: 0.2 }}
                >
                  <h3 className=" text-xl md:text-2xl font-semibold text-[#034837] mb-2 md:mb-6">
                    Send Us a Message
                  </h3>
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full flex items-center justify-center gap-2 bg-[#034837]  text-white py-3 px-6 rounded-lg font-medium shadow-md hover:shadow-lg transition-all disabled:opacity-70"
                    >
                      {isSubmitting ? (
                        <>
                          <svg
