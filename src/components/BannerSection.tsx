...
function BannerSection() {
  return (
    <section className=" w-[95vw] mx-auto my-12 flex flex-col lg:flex-row gap-8 rounded-4xl p-4">
      <div className=" w-full lg:w-1/2 rounded-4xl overflow-hidden relative lg:aspect-auto aspect-square">
        <img
          src="https://ik.imagekit.io/ajoy/Ebrahma%20Pragati/New-Ebrahma/project2.jpg?updatedAt=1756461282487"
          alt="banner-img-mobile"
          className=" aspect-square md:hidden w-full object-cover absolute inset-0"
        />
        <img src="https://ik.imagekit.io/ajoy/Ebrahma%20Pragati/New-Ebrahma/Banner.jpg?updatedAt=1756461460151" alt="banner-img-desktop" className=" hidden md:block object-cover w-full h-full absolute inset-0" />
      </div>
        ...
        <div className=" flex flex-col gap-6 lg:gap-8">
          <div className=" flex items-center justify-center">
            <div className=" flex items-start gap-4 xl:gap-8">
              ...
              <div className=" flex flex-col gap-2 lg:gap-4">
                <h5 className=" text-base md:text-lg lg:text-xl">Assured Growth</h5>
          ...
          <div className=" flex items-center justify-center">
            <div className=" flex items-start gap-4 xl:gap-8">
              ...
              <div className=" flex flex-col gap-2 lg:gap-4">
                <h5 className=" text-base md:text-lg lg:text-xl">Weekend Retreats</h5>
                <p className=" text-sm md:text-base lg:text-lg">
